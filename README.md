...
| **Защита от спама** | Ограничение частоты заявок с одного адреса |
| **Контакты и карта** | Телефоны, почта, адрес и интерактивная Яндекс.Карта |
...
**Просмотр возможен только в браузере**
```mermaid
flowchart LR
...
<sub>Подробные технические заметки для сопровождения — в файле `DEPLOYMENT.md`.</sub>
